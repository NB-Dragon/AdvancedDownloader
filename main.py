...
if __name__ == '__main__':
    ...
    url = "https://github.com/NB-Dragon/AdvancedDownloader/archive/refs/tags/v0.5.10.zip"
    base_info = {"download_link": url, "save_path": os.getcwd(), "thread_num": 32, "headers": headers, "open": True}
